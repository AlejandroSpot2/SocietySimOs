                  ...
                  return (
                    <div key={p.id} className="flex items-center gap-3 text-sm">
                      ...
                      <div className="flex flex-col">
                        ...
                        {icpPersonas.length > 0 && (
                          <span className="text-[9px] text-[#444444] tracking-wider uppercase">data-driven</span>
                        )}
                      </div>
                    </div>
                  );
  ...
  const renderPersonasTab = () => {
    ...
    return (
      <>
        ...
        <div className="flex-1 p-6 bg-[#111111] flex flex-col gap-6 overflow-y-auto custom-scrollbar">
          {icpPersonas.length > 0 && (
            <div className="text-[10px] font-bold tracking-[0.12em] uppercase text-[#22c55e] border border-[#22c55e]/40 bg-[#22c55e]/5 p-3 rounded-none">
              [ok] Showing {icpPersonas.length} data-driven personas from last real data run. Hardcoded personas will return on page reload.
            </div>
          )}
          {selectedPersona && (
            <>
